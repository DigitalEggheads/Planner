...
<head>
    ...
    <meta name="description" content="Shirkat-ul-Ras - Travels n Tours">
    <meta name="Digital Eggheads" content="Shirkat-ul-Ras">
    ...
    <header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-3">
                    <div id="logo_home">
                        <img src="img/Branding/logo.png" alt="City tours" data-retina="true">
                        <h1></h1>
                    </div>
                </div>
                <nav class="col-9">
