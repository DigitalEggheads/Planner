...
if(!isset($_SESSION))
  ...
  if (!isset($_SESSION["adminLogin"]) || !$_SESSION["adminLogin"] || isset($_POST["logout"])) {
    ...
    $AllTripPlannerQueries = getAllTripPlannerQueries();
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php foreach ($AllTripPlannerQueries as $key => $value) { ?>
                    
                    <tr>
                      <td><?=$value["TP_Name"]?></td>
                      <td><?=$value["TP_Whatsapp_Number"]?></td>
                      <td><?=$value["TP_Email"]?></td>
                      <td><?=$value["TP_Dep_Country"]?></td>
                      <td>
                        <a href="./view-queries.php?TP_Id=<?=$value["TP_Id"]?>" class="btn btn-sm btn-secondary"><i class="fas fa-eye"></i></a> &nbsp;
