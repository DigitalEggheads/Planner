                ...
                <div class="col-lg-12">
                    ...
                    <div class="row text-center mr-4 ml-4">
                        <div class="col-lg-4 offset-lg-2 other_tours">
                            <ul>
                                <li class="custom-city"><a href="javascript:void(0);"><img src="img/Destinations/Makkah-city-thumbnail.jpg" class="img-responsive rounded-circle mx-auto d-block" alt=""></a>
                                </li>
                        ...
                        <div class="col-lg-4 other_tours">
                            <ul>
                                <li class="custom-city"><a href="javascript:void(0);"><img src="img/Destinations/Madina-city-thumbnail.jpg" class="rounded-circle mx-auto d-block" alt=""></a>
                                </li>
