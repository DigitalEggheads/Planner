  ...
  <section class="parallax-window" data-parallax="scroll" data-image-src="img/Page-Title-Bg.jpg" data-natural-width="1400" data-natural-height="470">
    ...
    <section class="form-box" >
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-10 col-md-8  col-lg-6 form-wizard">
                            ...
                            <h4>Basic Details: <span>Step 1 - 4</span></h4>
                                ...
                                <div class="form-group">
                                    <label>Whatsapp Number: <span>*</span></label>
                                          <input type="tel" name="Phone" placeholder="Whatsapp Number" class="form-control required">
                                </div>
                                <div class="form-group">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label>Adults: <span>*</span></label>
                                          <input type="number" name="adults" placeholder="Number Of Adults" class="form-control required">
                                </div>
                                <div class="form-group">
                                    <label>Children: <span>*</span></label>
                                          <input type="number" name="children" placeholder="Children Of Adults" class="form-control required">
                                </div>
